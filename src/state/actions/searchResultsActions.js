...
const handlePlacesFetch = (coordinates, dispatch) => {
  ...
  const googleURL = `https://cors-proxy.htmldriven.com/?url=https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${corStr}&radius=1500&types=bar&key=${apiKey}`
